...
# 作者：Condy 🐙
# 使用方法: curl -fsSL https://your-domain.com/install-openclaw-easy.sh | bash
...
# 下載並運行安裝器
download_and_run() {
    INSTALLER_URL="https://raw.githubusercontent.com/yourname/openclaw-easy-installer/main/openclaw_easy_installer.py"
    TEMP_DIR=$(mktemp -d)
